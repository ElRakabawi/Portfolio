  ...
  return (
    <nav className='center nav'>
      ...
      >
        ...
        <li className='nav__list-item'>
          <a
            href='https://www.researchgate.net/profile/Muhammed-S-Elrakabawi'
            target='_blank'
            rel='noreferrer'
            className='link--nav'
          >
            <span>
              ...
              >
                <path
                  ...
                  fill={`${themeName === 'dark' ? '#cdcdff' : '#555'}`}
                />
              </svg>
            </span>
          </a>
        ...
        <li className='nav__list-item'>
          <a
            href='https://medium.com/@elrakabawi'
            target='_blank'
            rel='noreferrer'
            className='link--nav'
          >
      ...
      >
        {themeName === 'dark' ? (
          ...
          <Brightness2Icon style={{ transform: 'rotate(150deg)' }} />
        )}
      </button>
